...
local Window = Rayfield:CreateWindow({
   Name = "海豚脚本",
   LoadingTitle = "欢迎使用海豚脚本！！🤓🤓🤓",
   LoadingSubtitle = "by zhanqpa",
   ConfigurationSaving = {
      Enabled = false,
   ...
   KeySettings = {
      ...
      Key = {"Iampurpleguy123"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
...
Rayfield:Notify({
   Title = "你居然使用了海豚脚本！！！🤓🤓🤓",
   Content = "温馨提示:伸缩脚本GUI时不要把收缩条放在屏幕太往上的位置，一定要放在最下面！！！",
   Duration = 5,
   Image = 13047715178,
...
local Tab = Window:CreateTab("🔥游戏脚本🔥", 4483362458) -- Title, Image
local Button = Tab:CreateButton({
   Name = "doors blacking最强",
   Callback = function()
...
local Button = Tab:CreateButton({
   Name = "复制高级版discord官方频道（可以给你秘钥，需要梯子）",
   Callback = function()
...
local Tab1 = Window:CreateTab("各大脚本/中心🎲", 4483362458) -- Title, Image

local Tab2 = Window:CreateTab("•==公告==•", 4483362458) -- Title, Image

local Label = Tab2:CreateLabel("此脚本为半缝合脚本，功能可能有点少，如有建议请加作者vx或QQ")
